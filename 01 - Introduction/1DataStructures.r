...
patient_names[1]
patient1 <- list(full_name = patient_names[1], temperature = temperatures[1], gender=gender[1], vacccine = vaccine_status[1])
patient1
patient1[2]

patients_df = data.frame(patient_names, temperatures, vaccine_status, gender)
patients_df

patients_df$patient_names
