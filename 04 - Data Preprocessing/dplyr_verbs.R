# Fills a gap from Chapter 4: dplyr is loaded elsewhere in this folder
# (seperatingstrings.R, unstackingandstacking.R) but its core verbs are
# never actually demonstrated. These five are the ones you'll use daily.
