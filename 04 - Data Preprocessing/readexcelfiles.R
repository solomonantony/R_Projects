# Fills a gap from Chapter 4: opencsvfiles.R and opentxtfiles.R cover
# read.csv() and read.table(), but not Excel files - which is often the
# actual format business data arrives in.
