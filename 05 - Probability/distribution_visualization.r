# Adds visualization to Chapter 5: continuousprob.r and discreteprob.r
# compute probabilities as numbers (via pnorm, dbinom, etc.) but never
# show the distribution shape or which region a probability corresponds
# to - usually the most useful part for building intuition.
