# Fills a gap from Chapter 8: every lm() call in this folder uses only
# numeric predictors. Dummy-coding for categorical predictors is shown
# in Chapters 10-11 for machine learning models, but never tied back to
# a plain lm() regression, where it's most commonly first taught.
