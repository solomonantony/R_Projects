# Adds visualization to Chapter 8: none of the selection-method files
# (stepwise.r, forwardselection.r, backwardselection.R, bestsubsets.r)
# ever check whether the CHOSEN model actually fits well. Diagnostic
