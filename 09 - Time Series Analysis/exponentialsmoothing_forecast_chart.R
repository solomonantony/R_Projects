# Adds charting + an actual forecast to exponentialsmoothing.r, which
# computes an exponentially-smoothed series but never plots it or
# forecasts a future period.
