# Adds charting + an actual future forecast to exponentialtrend.r, which
# fits lm(log(Revenue) ~ Year) and prints summary() but never plots the
# curve (on the original scale) or predicts a future year.
