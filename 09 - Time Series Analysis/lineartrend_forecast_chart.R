# Adds charting + an actual future forecast to lineartrend.r, which fits
# lm(Sales ~ Year) and prints summary() but never plots the trend line
# or predicts a future year.
